...
import com.plcoding.cryptotracker.crypto.presenatation.model.toDisplayableNumber
...
fun CoinDetailScreen(
    ...
    } else if (state.selectCoin != null) {
        val coin = state.selectCoin
        Column(
            modifier = modifier
                .fillMaxSize()
            ...
            FlowRow(
                ...
                val absoluteChangeFormated = (coin.priceUsd.value * (coin.changePercent24Hr.value /100))
                    .toDisplayableNumber()
                ...
                InfoCard(
                    ...
                    formattedText = "$ ${absoluteChangeFormated.formatted}}",
                    icon = if (isPositive) {
